        ...
        <div className="bg-card border-x border-b border-border rounded-b-2xl -mt-20 relative pt-20 pb-6 px-8">
            ...
            <div className="flex gap-4">
              ...
              <div className="mt-4">
                <div className="flex items-center gap-2 mb-1">
                  <h1 className="text-2xl font-bold text-foreground">Lam Hoang</h1>
                ...
                <p className="text-foreground max-w-2xl leading-relaxed mb-3">
                  🟢 Dreamer | 📚 Learner | 🚀 Doer Exploring life one step at a time. ✨
          ...
          <Tabs defaultValue="posts" className="w-full">
            ...
            <TabsContent value="likes" className="mt-6">
              <p className="text-muted-foreground text-center py-8">No liked posts yet</p>
            </TabsContent>
          </Tabs>
      </div>
    </div>
