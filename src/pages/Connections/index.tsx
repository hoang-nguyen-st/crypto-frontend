...
const Connections = () => {
  return (
    <div className="max-w-[1200px] mx-auto py-6 px-8">
        ...
        <p className="text-muted-foreground mb-8">Manage your network and discover new connections</p>
        ...
        <Tabs defaultValue="followers" className="w-full">
              ...
              {connections.map((connection, index) => (
                <div key={index} className="bg-card border border-border rounded-2xl p-6">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-sm text-muted-foreground mb-3">{connection.username}</p>
                    <p className="text-sm text-muted-foreground mb-4 line-clamp-2">{connection.bio}</p>
          ...
          <TabsContent value="pending">
            <p className="text-center text-muted-foreground py-8">No pending connections</p>
          </TabsContent>
